...
public:
    ...
    geometry_msgs::Twist potential_fields(const std::vector<ObstacleInfo>& obstacles_array, float xr, float yr);

    geometry_msgs::Twist vortex_fields(const std::vector<ObstacleInfo>& obstacles_array, float xr, float yr);
